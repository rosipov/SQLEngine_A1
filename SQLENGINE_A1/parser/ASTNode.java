...
public class ASTNode {
	public enum Type {
		...
		INSERT, SELECT, UPDATE, DROP, DELETE, CREATE, INTO, FROM, VALUES, TABLE, SAVE, COMMIT, LOAD, DATABASE, QUIT, NOT, NULL, WHERE, EVAL, SET, AND, OR,
		LT_COMPARISON, GT_COMPARISON, EQ_COMPARISON, NE_COMPARISON, GE_COMPARISON, LE_COMPARISON, LOGICAL_EXPRESSION,
